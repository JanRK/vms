rm -f /usr/share/keyrings/zt-gpg-key
echo '-----BEGIN PGP PUBLIC KEY BLOCK-----' >/usr/share/keyrings/zt-gpg-key
cat >>/usr/share/keyrings/zt-gpg-key << END_OF_KEY
...
=JgAv
END_OF_KEY
echo '-----END PGP PUBLIC KEY BLOCK-----' >>/usr/share/keyrings/zt-gpg-key
...
sudo zerotier-cli join e5cd7a9e1c4a799a
